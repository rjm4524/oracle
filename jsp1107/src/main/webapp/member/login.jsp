		...
		<div id="outbox">		
			...
			<div id="contents">
				<div id="member">
					...
					<div class="informbox">
						<div class="inform">
						<form name="j_frm" method="post" action="do_login.jsp">
							<ul>
								<li><input type="text" class="loginType" name="id" id="id" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='loginType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
								<li><input type="password" class="passType" name="pw" id="pw" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='passType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
							</ul>
							</form>
