				...
				<div id="mypage">
					...
					$(function(){
						$(".replyBtn").click(function(){
							...
							var htmlDate ='';
							htmlDate += '<ul id="0">';
							htmlDate += '<li class="name"> aaa <span>[2023-12-05]</span></li>';
							htmlDate += '<li class="txt">'+ccontent+'</li>';
							htmlDate += '<li class="btn">';
							htmlDate += '<a class="rebtn">수정</a>&nbsp';
							htmlDate += '<a class="rebtn">삭제</a>';
							htmlDate += '</li>';
							htmlDate += '</ul>';
							
							//댓글등록후 내용지우기
							$(".replyBox").prepend(htmlDate); //append()-마지막 , prepend()-처음, html()-삭제후 추가
							alert("댓글을 등록합니다.");
							$(".replyType").val("");
