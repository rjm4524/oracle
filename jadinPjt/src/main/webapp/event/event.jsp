					...
					<div class="eventList">
						<ul>
							...
							<c:forEach items="${list}" var="edto">
								<li>
									<div class="img">
										<a href="event_view.do?bno=${edto.bno}"><img src="../upload/${edto.bfile}" alt="진행중 이벤트" /></a>
									</div>
									<div class="txt">
										<div class="subject">${edto.btitle}</div>
										<div class="day">이벤트 기간 : ${edto.bdate} ~ 2014-04-29</div>
									</div>
								</li>
							</c:forEach>
							<!-- //반복 -->
