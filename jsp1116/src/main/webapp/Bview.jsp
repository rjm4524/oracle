...
<html>
	...
	<body>
	  ...
	  <div>
	   <h1><i class="fa fa-users" aria-hidden="true"></i>회원정보보기</h1>
		   <table>
		   <colgroup>
		   	<col width="20%">
		   	<col width="80%">
		     ...
		     <tr>
		       <th><i class="fa fa-address-card" aria-hidden="true"></i>제목</th>
		         <td>${bdto.btitle }</td>
		     </tr>
		     <tr>
		       <th><i class="fa fa-square" aria-hidden="true"></i>내용</th>
		         <td>${bdto.bcontent }</td>
		     </tr>
		     <tr>
		       <th>이미지</th>
